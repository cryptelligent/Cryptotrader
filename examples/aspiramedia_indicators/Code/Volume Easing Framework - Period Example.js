...
init: (context) ->
  ...
  context.easing           = 4  # How much to ease things through. Must be positive. Go higher than 1 to make it harder to buy/sell in high volumes
  context.trigger          = 2  # When to make the easing occur. Positive value. (Natr)
...
handle: (context, data)->
    ...
    if price > (instrument.ema(21 + easing) * 1.01)
      buy instrument
    if price < (instrument.ema(21 + easing) * 0.99)
      sell instrument
