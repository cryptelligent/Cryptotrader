#by WaveTrader
#see also https://cryptotrader.org/topics/410871/margin-framework-open-positions-calculate-pl-calculate-balance
...
LEVLONG    = params.add 'Leverage LONG', 1
LEVSHORT   = params.add 'Leverage SHORT', 1
MA1P    = params.add 'MA1 Period)', 50
MA2P    = params.add 'MA2 Period)', 200
...
handle: ->
    ...
    ma1 = FUNCTIONS.SMA(instrument.close,MA1P)
    ma2 = FUNCTIONS.SMA(instrument.close,MA2P)
